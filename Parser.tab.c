...
{
  "$end", "error", "$undefined", "NUMBER", "NAME", "INT", "FOR", "RETURN",
  "IF", "ELSE", "CHAR", "VOID", "'+'", "'-'", "'*'", "'/'", "UMINUS",
  "'='", "';'", "'('", "')'", "$accept", "list_of_statements", "statement",
...
static const yytype_uint16 yytoknum[] =
{
     ...
     265,   266,    43,    45,    42,    47,   267,    61,    59,    40,
      41
};
# endif
...
{
      18,   -15,    21,   -16,    -3,   -16,   -16,   -16,   -16,    -3,
      -3,     5,   -16,    -9,    -3,    -3,    -3,    -3,   -16,   -16,
      12,    12,   -16,   -16
};
...
{
       0,     0,     0,     2,     0,     1,     3,    11,    12,     0,
       0,     0,    10,     0,     0,     0,     0,     0,     4,     9,
       5,     6,     7,     8
};
...
{
       7,     8,     4,    14,    15,    16,    17,    12,    13,     6,
       9,    19,    20,    21,    22,    23,    10,    14,    15,    16,
      17,     5,     1,    18,     0,     1,    16,    17
};

static const yytype_int8 yycheck[] =
{
       3,     4,    17,    12,    13,    14,    15,     9,    10,     2,
      13,    20,    14,    15,    16,    17,    19,    12,    13,    14,
      15,     0,     4,    18,    -1,     4,    14,    15
};
...
{
       0,     4,    22,    23,    17,     0,    23,     3,     4,    13,
      19,    24,    24,    24,    12,    13,    14,    15,    18,    20,
      24,    24,    24,    24
};
...
#line 38 "Parser.y" /* yacc.c:1646  */
    { 
	qArray[quadPtr++] = new_quad_unary(COPY, (yyvsp[-3].symp)->name, (yyvsp[-1].symp)->name);
	printrule("S -> id = E"); 
}
...
#line 68 "Parser.y" /* yacc.c:1646  */
    { (yyval.symp) = (yyvsp[-1].symp); printrule("E -> (E)"); }
...
#line 70 "Parser.y" /* yacc.c:1646  */
    {
	(yyval.symp) = gentemp();
	qArray[quadPtr++] = new_quad_unary(UNARYMINUS, (yyval.symp)->name, (yyvsp[0].symp)->name);
	printrule("E -> -E");
}
...
#line 76 "Parser.y" /* yacc.c:1646  */
	...
	(yyval.symp) = gentemp();
	char num_s[10];
	sprintf(num_s, "%d", (yyvsp[0].intval));
...
#line 84 "Parser.y" /* yacc.c:1646  */
    { (yyval.symp) = (yyvsp[0].symp); printrule("E -> id"); }
